// packages/frontend/src/widgets/page-loader/container.tsx

import { FC, memo, useEffect } from 'react';
import { useUI, PageLoadingItem } from 'entities/ui';
    ...
    >
      <Box sx={{ ...f('c-fs-fe'), minWidth: '30%', gap: 1 }}>
        {Object.entries(pageLoading).map(([key, value]) => (
          <PageLoaderRow key={key} text={(value as PageLoadingItem).text} />
        ))}
