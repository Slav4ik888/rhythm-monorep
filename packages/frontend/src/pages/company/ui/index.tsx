...
const CompanyPage: FC = memo((): React.ReactElement | null => {
  ...
  useEffect(() => {
    ...
    } else if (!auth && _isLoaded && _isParamsCompanyIdLoaded && !dashboardPublicAccess) {
    ...
    } else if (auth && _isLoaded && _isParamsCompanyIdLoaded && !isDashboardAccessView) {
