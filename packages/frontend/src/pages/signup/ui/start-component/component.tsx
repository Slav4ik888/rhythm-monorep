...
export const SignupStartPageComponent: FC<Props> = memo(
  ({
    ...
    <>
      ...
      <GettingPermissionsContainer permissins={permissins} onTogglePermission={onTogglePermission} />
      <ActionMain type='signup' loading={loading} errors={errors} onSubmit={onSubmit} />
    </>
  ),
);
