// packages/frontend/src/shared/lib/colors-picker/popover-colors-picker/index.tsx
      ...
      {isOpen && (
        <Box sx={sx.popover} ref={popoverRef}>
          ...
          <Box sx={sx.control}>
            ...
            />
            <CopyBtn value={rgbaToHexWithAlpha(rgba(color))} toolTitle='Скопировать цвет' sx={sx.icon} />
            <IconButton
