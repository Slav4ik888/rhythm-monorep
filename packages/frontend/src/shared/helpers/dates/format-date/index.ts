// packages/frontend/src/shared/helpers/dates/format-date/index.ts
...
export function formatDate(
  ...
  switch (format) {
    case 'Month':
      return getMonth(date, sub);
    case 'Month YYYY':
      return getMonthYYYY(date, sub);
    case 'Month DD, YYYY':
      return getMonthDDсYYYY(date, sub);
    case 'DD Month YYYY':
      return getDDMonthYYYY(date, sub);
    case 'D Month YYYY':
      return getDMonthYYYY(date, sub);
    case 'D Month YYYY HH:MM':
      return getDMonthYYYYHHMM(date, sub);
    case 'DD Mon YY':
      return getDDMonYY(date, sub);
    case 'DD mon YY':
      return getDDmonYY(date, sub);
    case 'YYYY-MM-DD':
      return getYYYYMMDDt(date);
    case 'YYYYMMDD':
      return getYYYYMMDD(date);
    case 'DD-MM-YYYY':
      return getDDMMYYYYt(date);
    case 'DD.MM.YYYY':
      return getDDMMYYYYd(date);
    case 'DD.MM.YY':
      return getDDMMYYd(date);
    case 'DD.MM.YY HH:MM':
      return getDDMMYYdHHMM(date);
    case 'HH:MM':
      return getHHMM(date);
