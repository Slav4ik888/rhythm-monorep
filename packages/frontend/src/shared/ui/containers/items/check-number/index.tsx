// packages/frontend/src/shared/ui/containers/items/check-number/index.tsx
...
export const CheckNumber: React.FC<Props> = ({
  group: G,
  grid,
  fullWidth,
  changesValue,
  ...
  const handlerBlur = (value: number) => changeGroup(G, [{ value, scheme }]),
