// packages/frontend/src/shared/ui/pages/layouts/layout-inner-page/page-header-title/index.tsx
...
export const PageHeaderTitle: FC<Props> = memo(({ type }) => (
  <>
    ...
    <Typography component='h1' variant='h5' color='text.dark' sx={{ textAlign: 'center', mb: 2 }}>
      {title[type]}
    </Typography>
  </>
));
