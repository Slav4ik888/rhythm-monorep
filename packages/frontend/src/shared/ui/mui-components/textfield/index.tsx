// packages/frontend/src/shared/ui/mui-components/textfield/index.tsx
...
export const TextFieldItem = forwardRef<null, TextFieldItemProps>((props, ref) => {
  const { disabled, scheme, errors, errorScheme, fullWidth = true, onCancel, onChange, onSubmit, ...rest } = props;
