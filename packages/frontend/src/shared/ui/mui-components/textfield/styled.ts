// packages/frontend/src/shared/ui/mui-components/textfield/styled.ts
...
export default styled(TextField)(({ theme, ownerState }: { theme: CustomTheme; ownerState?: OwnerState }) => {
  ...
  const errorSvg = [
    ...
    "stroke='%23F44335' viewBox='0 0 12 12'%3E",
    "%3Ccircle cx='6' cy='6' r='4.5'/%3E",
    "%3Cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3E",
    "%3Ccircle cx='6' cy='8.2' r='.6' fill='%23F44335' stroke='none'/%3E",
    '%3C/svg%3E',
  ].join('');
