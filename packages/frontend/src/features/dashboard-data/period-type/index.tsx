// packages/frontend/src/features/dashboard-data/period-type/index.tsx
  ...
  return (
    ...
    >
      ...
      <Select
        ...
        // @ts-ignore MUI 9: slotProps для Menu теперь через MenuListProps
        slotProps={{ paper: { sx: (theme: any) => ({ backgroundColor: (theme as CustomTheme).palette.navbar.bg }) } }}
        sx={{
          visibility: 'hidden',
          opacity: 0,
          height: pxToRem(38),
      ...
      >
        {arrayDashboardPeriodType.map((item) => (
          <MenuItem
            key={item}
            value={item}
