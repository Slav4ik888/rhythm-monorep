...
const prevObj = {
  ...
  firstArrObj: [
    { a: 'first 123', b: 'first 234' },
    { c: 'first 567', d: 'first 890' },
  ],
  ...
  firstObjBig: {
    ...
    secondObjBig: {
      ...
      thirdArrObj: [
        { a: 'third 123', b: 'third 234' },
        { c: 'third 567', d: 'third 890' },
      ],
      ...
      thirdObjBig: {
        ...
        fourthArrObj: [
          { a: 'fourth 123', b: 'fourth 234' },
          { c: 'fourth 567', d: 'fourth 890' },
        ],
