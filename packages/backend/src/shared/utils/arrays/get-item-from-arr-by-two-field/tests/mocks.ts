// packages/backend/src/shared/utils/arrays/get-item-from-arr-by-two-field/tests/mocks.ts
...
export const mocks: Mocks = [
  [
    { arr: arr1, ff: 'id', vf: 111, fs: 'name', vs: 'Slava' },
  ...
  [
    { arr: arr1, ff: 'id', vf: 2, fs: 'name', vs: 'Regina' },
