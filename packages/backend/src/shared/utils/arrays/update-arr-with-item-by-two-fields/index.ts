// packages/backend/src/shared/utils/arrays/update-arr-with-item-by-two-fields/index.ts
...
export function updateArrWithItemByTwoFields(
  ...
  const idx = items.findIndex(
    (item) => item[fieldOne] === updateItem[fieldOne] && item[fieldTwo] === updateItem[fieldTwo],
  );
