// packages/backend/src/libs/loggers/winston/index.ts
...
const loggerLogin = createLogger({
  level: 'info',
  format: combine(label({ label: 'login' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerSignup = createLogger({
  level: 'info',
  format: combine(label({ label: 'signup' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerUser = createLogger({
  level: 'info',
  format: combine(label({ label: 'user' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerCompany = createLogger({
  level: 'info',
  format: combine(label({ label: 'company' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerDocs = createLogger({
  level: 'info',
  format: combine(label({ label: 'docs' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerDashboardView = createLogger({
  level: 'info',
  format: combine(label({ label: 'dashboardView' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerDashboardTemplates = createLogger({
  level: 'info',
  format: combine(label({ label: 'dashboardTemplates' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerPartner = createLogger({
  level: 'info',
  format: combine(label({ label: 'partner' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
...
const loggerUrl = createLogger({
  level: 'info',
  format: combine(label({ label: 'url' }), timestamp(), myFormat),
  transports: [
    new transports.File({ filename: path.join(__dirname, rootPath, 'errors.log'), level: 'error' }),
