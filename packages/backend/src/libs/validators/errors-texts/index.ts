// packages/backend/src/libs/validators/errors-texts/index.ts
...
export enum ErrorText {
  ...
  PERMISSONS_DISABLED = 'Для регистрации, заполните необходимые поля' +
    ' и предоставьте согласие на обработку персональных данных',
