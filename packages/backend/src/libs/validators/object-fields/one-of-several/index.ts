// packages/backend/src/libs/validators/object-fields/one-of-several/index.ts
...
export const validateOneOfSeveral = (
  ...
  if (isNotOneOfSeveral(Object.values(list), value)) {
    return getValidResult({ [field]: ErrorText.NOT_ONE_OF_SEVERAL });
  }
