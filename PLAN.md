...
- [ ] 2.1 Unit-тесты на критическую бизнес-логику бэкенда
- [ ] 2.2 Unit-тесты на фронтенд (стора, хуки, хелперы)
- [ ] 2.3 Smoke-тесты для ключевых страниц
- [ ] 2.4 `npm test -w packages/backend` — проходит
- [ ] 2.5 `npm test -w packages/frontend` — проходит
