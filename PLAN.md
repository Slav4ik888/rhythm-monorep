...
- [ ] 3.6 Koa → NestJS + Fastify (фаза 1: инфраструктура готова — main.ts, AppModule, FirebaseAuthGuard, LoggingInterceptor, @CurrentUser, docs-контроллер мигрирован; фаза 2: params-company, partner, loggers, templates мигрированы; Koa сохранён для обратной совместимости; остались google, company, user, auth, dashboard)
