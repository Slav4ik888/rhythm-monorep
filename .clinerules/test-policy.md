...
| 🥈 5      | **Widgets**         | `widgets/auth/`, `widgets/sidebar/`, `widgets/navbar/`, `widgets/footer/`, `widgets/dashboard-view/`, `widgets/dashboard-render/`                     | ✅ smoke (auth/accept-cookie, sidebar, navbar, footer, dashboard-view/panel, dashboard-data/datebar, hints, message-bar, page-loader) |
...
**Итого (весь проект):** 170 suites (backend) + 427 suites (frontend) + 6 suites (e2e) = **603 suites**;
1115 тестов (backend) + 3053 тестов (frontend) + 22 теста (e2e) = **4190 тестов**.
