...
**Итого (бэкенд):** 140 suites, 1017 тестов (unit 490 + shared 377 + validators 150), включая integration-тесты всех 10 контроллеров.
...
**Итого (весь проект):** 140 suites (backend) + 377 suites (frontend) + 6 suites (e2e) = **523 suites**;
1017 тестов (backend) + 2926 тестов (frontend) + 22 теста (e2e) = **3965 тестов**.
